 ...
 */
 ...
 (function($){
	...
	$.fn.tableUpdatedPagination = function(settings) {
		var defaults = {   
			prevArrow : (new Image()).src="images/pagination/previous.gif",
			nextArrow : (new Image()).src="images/pagination/refresh.jpg",
			rowsPerPage : 4,
			currPage : 2,
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push("<select id='tablePagination_rowsPerPage' hidden='true'><option value='3'>3</option></select>");
        htmlBuffer.push("</span>");
        var myElem = document.getElementById('tablePagination_paginater');
        if(myElem != null)
        {
        	myElem.outerHTML = "";
        	delete myElem;
      	...
      	htmlBuffer.push("<span id='tablePagination_paginater'>");
       	htmlBuffer.push("<img id='tablePagination_nextPage' position='relative' height='45' width='45' src='"+defaults.nextArrow+"'>");
       	htmlBuffer.push("</span>");
        htmlBuffer.push("</div>");
